...
Open Source Software (OSS) is the backbone of most software, tools, apps, electronics and more that we use every day. Open Source Friday also encourages business to repay the software by allowing free time for colleagues with expiring OSSes.
